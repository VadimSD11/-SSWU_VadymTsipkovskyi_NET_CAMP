        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountOfViewers = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventId = table.Column<int>(type: "int", nullable: false),
                    TeamId = table.Column<int>(type: "int", nullable: false),
                    WinCoefficient = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DrawCoefficient = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    LoseCoefficient = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Coefficients", x => x.CoefficientId);
                    table.ForeignKey(
                        name: "FK_Coefficients_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Coefficients_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coefficients_EventId",
                table: "Coefficients",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_Coefficients_TeamId",
                table: "Coefficients",
                column: "TeamId");
